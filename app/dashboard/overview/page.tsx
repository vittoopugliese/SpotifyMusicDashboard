...
import DashboardOverviewSkeleton from "@/components/page-skeletons/dashboard-overview-skeleton";
...
export default function OverviewPage() {
  ...
  const { loading: sessionLoading } = useSpotifySession();
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <InsightCard insight={insight} loading={false} />
    </div>
  );
}