  ...
  return (
    <SidebarInset>
      <div className="position-fixed top-0 left-0 right-0 z-10">
        { session.authenticated && <AppHeader /> }
      </div>
      <div className="flex flex-1 flex-col sm:ml-4 bg-muted/50 min-h-[100vh] sm:rounded-t-2xl rounded-none sm:rounded-r-none flex-1 md:min-h-min">
