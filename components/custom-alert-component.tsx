...
export default function CustomAlertComponent({ title, description, variant = "default", className }: { title: string; description: string; variant?: "default" | "destructive"; className?: string }) {
  return (
