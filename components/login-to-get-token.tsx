    ...
    <div className="sm:rounded-tl-2xl rounded-none min-h-screen bg-gradient-to-b from-primary/25 via-background to-black/80">
      ...
      <div className="container mx-auto px-4 py-16 md:py-24">
        <div className="max-w-4xl mx-auto bg-gradient-to-r from-primary/10 via-chart-2/10 to-primary/10 border border-primary/20 rounded-2xl p-8 md:p-12 text-center">
          <h2 className="text-3xl md:text-3xl font-bold mb-4 flex items-center justify-center gap-3">
            <AudioWaveform className="w-7 h-7 text-primary" />
            Ready to explore your music?
          </h2>
          <p className="text-md text-muted-foreground mb-8 max-w-2xl mx-auto">Connect your Spotify account and start discovering insights about your music taste today.</p>
          <Button size="lg" onClick={login} className="text-md px-6 py-4" >
            Get Started Now
