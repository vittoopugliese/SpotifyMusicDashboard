...
export function PlaylistProfileSkeleton() {
  return (
        ...
        <div className="relative h-full max-w-7xl mx-auto px-6 flex items-end pb-8">
          <div className="flex flex-col md:flex-row items-center md:items-end gap-6 w-full">
            ...
            <div className="relative">
              <Skeleton className="h-48 w-48 md:h-64 md:w-64 rounded-lg border-4 border-background shadow-2xl" />
            </div>
            ...
            <div className="flex-1 text-center md:text-left space-y-4 w-full md:w-auto">
              <div>
                ...
                <Skeleton className="h-12 md:h-16 w-64 md:w-96 mb-2 mx-auto md:mx-0" />
                <Skeleton className="h-5 w-48 mb-4 mx-auto md:mx-0" />
                <Skeleton className="h-4 w-64 md:w-80 mb-4 mx-auto md:mx-0" />
              </div>
